...
class Operador_Decremento extends Expresion_1.default {
    constructor(p_fila, p_columna, p_operador_izq) {
        super(p_fila, p_columna, 2 /* RESTA */, p_operador_izq);
    }
    ejecutar(entorno_padre, salida) {
        ...
        try {
            ...
            if (!(op1.getTipo().getTipo() == 3 /* NUMERO */)) {
                ...
                _return.setFila(this.fila);
                _return.setColumna(this.columna);
                _return.setValor("No es posible realizar Operador Decrementos con valores no numericos.");
                return _return;
            }
            else {
            ...
            _return.setFila(this.fila);
            _return.setColumna(this.columna);
            _return.setValor("Operador Decremento: " + Exception.Message);
            return _return;
        }
    }
    getThis() {
...
exports.default = Operador_Decremento;
//# sourceMappingURL=Operador_Decremento.js.map
//# sourceMappingURL=Operador_Decremento.js.map