...
class Menor_Igual_Que extends Expresion_1.default {
    constructor(p_fila, p_columna, p_operador_izq, p_operador_der) {
        super(p_fila, p_columna, 11 /* MENOR_IGUAL_QUE */, p_operador_izq, p_operador_der);
        this.matriz_operacion_menor_igual_que = [
            ...
            /*numero*/ [57 /* error */, 57 /* error */, 57 /* error */, 38 /* menorigualque_numerico */, 41 /* menorigualque_cadena_numerico */, 57 /* error */, 57 /* error */],
            /*String*/ [57 /* error */, 57 /* error */, 57 /* error */, 41 /* menorigualque_cadena_numerico */, 24 /* mayorque_cadena */, 57 /* error */, 57 /* error */],
    ...
    ejecutar(entorno_padre, salida) {
        ...
        try {
            ...
            switch (tipo_menor_igual_que) {
                case 38 /* menorigualque_numerico */:
                    ...
                    return _return;
                case 41 /* menorigualque_cadena_numerico */:
                    var numero = 0;
                    ...
                    return _return;
                case 40 /* menorigualque_numerico_cadena */:
                    var numero = 0;
                ...
                default:
                    ...
                    _return.setFila(this.fila);
                    _return.setColumna(this.columna);
                    _return.setValor("No es posible realizar una Comparación Menor Igual Que del tipo: " + op1.getTipo().getTraduccion() + " * " + op2.getTipo().getTraduccion());
                    return _return;
            }
        }
        catch (Exception) {
            ...
            _return.setFila(this.fila);
            _return.setColumna(this.columna);
            _return.setValor("Operacion Menor Igual Que: " + Exception.Message);
            return _return;
        }
    }
    getThis() {
...
//# sourceMappingURL=Menor_Igual_Que.js.map
//# sourceMappingURL=Menor_Igual_Que.js.map