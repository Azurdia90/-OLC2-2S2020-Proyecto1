...
class Or extends Expresion_1.default {
    constructor(p_fila, p_columna, p_operador_izq, p_operador_der) {
        super(p_fila, p_columna, 17 /* OR */, p_operador_izq, p_operador_der);
    }
    ejecutar(entorno_padre, salida) {
        ...
        try {
            ...
            if (!(op1.getTipo().getTipo() == 2 /* BOOLEANO */ || !(op2.getTipo().getTipo() == 2 /* BOOLEANO */))) {
                ...
                _return.setFila(this.fila);
                _return.setColumna(this.columna);
                _return.setValor("No es posible realizar Or con valores no booleanos.");
                return _return;
            }
            else {
            ...
            _return.setFila(this.fila);
            _return.setColumna(this.columna);
            _return.setValor("Operacion Or: " + Exception.Message);
            return _return;
        }
    }
    getThis() {
