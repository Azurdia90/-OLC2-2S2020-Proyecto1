...
class Menor_Que extends Expresion_1.default {
    constructor(p_fila, p_columna, p_operador_izq, p_operador_der) {
        super(p_fila, p_columna, 9 /* MENOR_QUE */, p_operador_izq, p_operador_der);
        this.matriz_operacion_menor_que = [
            ...
            /*numero*/ [57 /* error */, 57 /* error */, 57 /* error */, 28 /* menorque_numerico */, 31 /* menorque_cadena_numerico */, 57 /* error */, 57 /* error */],
            /*String*/ [57 /* error */, 57 /* error */, 57 /* error */, 31 /* menorque_cadena_numerico */, 24 /* mayorque_cadena */, 57 /* error */, 57 /* error */],
        ...
        try {
            ...
            switch (tipo_menor_que) {
                case 28 /* menorque_numerico */:
                    ...
                    return _return;
                case 31 /* menorque_cadena_numerico */:
                    var numero = 0;
                    ...
                    return _return;
                case 30 /* menorque_numerico_cadena */:
                    var numero = 0;
...
//# sourceMappingURL=Menor_Que.js.map
//# sourceMappingURL=Menor_Que.js.map