...
class Operador_Unario extends Expresion_1.default {
    constructor(p_fila, p_columna, p_operador_izq) {
        super(p_fila, p_columna, 3 /* MULTIPLICACION */, p_operador_izq);
    }
    ejecutar(entorno_padre, salida) {
        ...
        try {
            ...
            if (!(op1.getTipo().getTipo() == 3 /* NUMERO */)) {
                ...
                _return.setFila(this.fila);
                _return.setColumna(this.columna);
                _return.setValor("No es posible realizar Operador Unario con valores no numericos.");
                return _return;
            }
            else {
            ...
            _return.setFila(this.fila);
            _return.setColumna(this.columna);
            _return.setValor("Operador Unario: " + Exception.Message);
            return _return;
        }
    }
    getThis() {
...
exports.default = Operador_Unario;
//# sourceMappingURL=Operador_Unario.js.map
//# sourceMappingURL=Operador_Unario.js.map