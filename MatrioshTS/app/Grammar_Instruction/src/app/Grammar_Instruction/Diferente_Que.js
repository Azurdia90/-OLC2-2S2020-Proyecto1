...
class Diferente_Que extends Expresion_1.default {
    constructor(p_fila, p_columna, p_operador_izq, p_operador_der) {
        super(p_fila, p_columna, 12 /* DIFERENTE_QUE */, p_operador_izq, p_operador_der);
        this.matriz_operacion_diferente_que = [
            [57 /* error */, 57 /* error */, 57 /* error */, 57 /* error */, 57 /* error */, 57 /* error */, 57 /* error */],
            /*nulo*/ [57 /* error */, 47 /* diferente_nulo */, 47 /* diferente_nulo */, 47 /* diferente_nulo */, 47 /* diferente_nulo */, 47 /* diferente_nulo */, 57 /* error */],
            /*booleano*/ [57 /* error */, 47 /* diferente_nulo */, 57 /* error */, 57 /* error */, 57 /* error */, 57 /* error */, 57 /* error */],
            /*numero*/ [57 /* error */, 47 /* diferente_nulo */, 57 /* error */, 43 /* diferente_numerico */, 46 /* diferente_cadena_numerico */, 57 /* error */, 57 /* error */],
            /*String*/ [57 /* error */, 47 /* diferente_nulo */, 57 /* error */, 46 /* diferente_cadena_numerico */, 24 /* mayorque_cadena */, 57 /* error */, 57 /* error */],
            /*identificador*/ [57 /* error */, 47 /* diferente_nulo */, 57 /* error */, 57 /* error */, 57 /* error */, 57 /* error */, 57 /* error */],
        ...
        try {
            ...
            switch (tipo_diferente_que) {
                case 47 /* diferente_nulo */:
                    ...
                    return _return;
                case 43 /* diferente_numerico */:
                    _return = new Simbolo_1.default(0 /* valor */, new Tipo_1.default(2 /* BOOLEANO */), "");
                    _return.setValor(Number(op1.getValor()) != Number(op2.getValor()));
                    return _return;
                case 46 /* diferente_cadena_numerico */:
                    var numero = 0;
                    ...
                    return _return;
                case 45 /* diferente_numerico_cadena */:
                    var numero = 0;
...
//# sourceMappingURL=Diferente_Que.js.map