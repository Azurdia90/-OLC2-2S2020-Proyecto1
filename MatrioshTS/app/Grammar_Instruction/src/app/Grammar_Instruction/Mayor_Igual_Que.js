...
class Mayor_Igual_Que extends Expresion_1.default {
    constructor(p_fila, p_columna, p_operador_izq, p_operador_der) {
        super(p_fila, p_columna, 10 /* MAYOR_IGUAL_QUE */, p_operador_izq, p_operador_der);
        this.matriz_operacion_mayor_igual_que = [
            ...
            /*numero*/ [57 /* error */, 57 /* error */, 57 /* error */, 33 /* mayorigualque_numerico */, 36 /* mayorigualque_cadena_numerico */, 57 /* error */, 57 /* error */],
            /*String*/ [57 /* error */, 57 /* error */, 57 /* error */, 36 /* mayorigualque_cadena_numerico */, 34 /* mayorigualque_cadena */, 57 /* error */, 57 /* error */],
    ...
    ejecutar(entorno_padre, salida) {
        ...
        try {
            ...
            switch (tipo_mayor_igual_que) {
                case 33 /* mayorigualque_numerico */:
                    ...
                    return _return;
                case 36 /* mayorigualque_cadena_numerico */:
                    var numero = 0;
                    ...
                    return _return;
                case 35 /* mayorigualque_numerico_cadena */:
                    var numero = 0;
...
//# sourceMappingURL=Mayor_Igual_Que.js.map