...
class Funcion_Pop extends Funcion
{
    ...
    public pasarParametros(lista_parametros_enviados : Array<Simbolo>, salida : Middle, p_padre?: Simbolo)
    {
        ...
        else 
        {
            ...
            _return.setFila(this.fila);
            _return.setColumna(this.columna);
            _return.setValor("Función Pop: no requiere parametros.");
            return _return;
        }    
    }
    ...
    public ejecutar(entorno_local : Map<String, Simbolo>, salida : Middle) 
    {
        ...
        {  
            ...
            if(this.padre.getRol()== tipo_rol.arreglo)
            {
                ...
                _return.setFila(this.fila);
                _return.setColumna(this.columna);
                _return.setValor("Sentencia Pop succesful.");
                return _return;
            }
            else
            {
                ...
                _return.setFila(this.fila);
                _return.setColumna(this.columna);
                _return.setValor("Sentencia Pop aplica únicamente en arreglos.");
                return _return;
            }
        }
        catch(Exception)
        {
            ...
            _return.setFila(this.fila);
            _return.setColumna(this.columna);
            _return.setValor("Error en Sentencia Pop: " + Exception);
            return _return;
        }
    }  
