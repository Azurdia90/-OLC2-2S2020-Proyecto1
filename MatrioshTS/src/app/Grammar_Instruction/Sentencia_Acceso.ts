...
class Sentencia_Acceso extends Instruction
{
    ...
    public ejecutar(entorno_padre : Map<String,Simbolo>, salida : Middle) 
    {
        ...
        {   
            ...
            else
            {
                ...
                if(simbolo_tmp.getRol() == tipo_rol.arreglo)
                {
                    ...
                    for(var x = 0; x < this.dimensiones.length; x++)
                    {
                        ...
                        else
                        {
                            ...
                            _return.setFila(this.fila);
                            _return.setColumna(this.columna);
                            _return.setValor("Sentencia Acceso: El valor de acceso debe ser tipo númerico.");
                            return _return;
                        }
                    }
                    ...
                    if(arreglo_tmp.length > 0 && lista_tamaños.length > 0)
                    {
                        ...
                        if(lista_tamaños.length == lista_accesos.length)
                        {
                            ...
                            if(pos_rel < 0)
                            {
                                ...
                                _return.setFila(this.fila);
                                _return.setColumna(this.columna);
                                _return.setValor("Sentencia Acceso: Los valores de acceso no deben ser valores negativos.");
                            }
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    _return.setFila(this.fila);
                                    _return.setColumna(this.columna);
                                    _return.setValor("Sentencia Acceso: El valor de las posiciones de acceso es mayor al tamaño del arreglo.");
                                }
                            }
                        }
                        else
                        {
                            ...
                            _return.setFila(this.fila);
                            _return.setColumna(this.columna);
                            _return.setValor("Sentencia Acceso: El cantidad de accesos no coincide con las dimensiones del arreglo.");
                        }
                    }
                    else
                    {   
                        ...
                        _return.setFila(this.fila);
                        _return.setColumna(this.columna);
                        _return.setValor("Sentencia Acceso: El arreglo no a sido instanciado.");
                    }
                ...
                else
                {
                    ...
                    _return.setFila(this.fila);
                    _return.setColumna(this.columna);
                    _return.setValor("Sentencia Acceso: Se especificaron dimension(es) de acceso para un No arreglo.");
                    return _return;
                } 
            }
            ...
            for(var cont = 0; cont < this.lista_accesos.length; cont++)
            {
                ...
                else if(_acceso.getRol() == tipo_rol.arreglo)
                {
                    ...
                    _acceso = this.lista_accesos[cont].ejecutar(entorno_padre, salida);
                }
        ...
        catch(Exception)
        {
            ...
            _return.setFila(this.fila);
            _return.setColumna(this.columna);
            _return.setValor("Sentencia Acceso " + this.identificador + ": " + Exception.Message);
            return _return;
        }
    }
