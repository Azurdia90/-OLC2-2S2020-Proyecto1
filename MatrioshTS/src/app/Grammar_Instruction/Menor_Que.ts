...
class Menor_Que extends Expresion
{
    ...
    [   /*                                      void                            nulo                           booleano                         numero                                           cadena                                       identificador                          error 
        ...
        /*numero*/        [ tipo_operacion_resultado.error, tipo_operacion_resultado.error, tipo_operacion_resultado.error, tipo_operacion_resultado.menorque_numerico,        tipo_operacion_resultado.menorque_cadena_numerico, tipo_operacion_resultado.error, tipo_operacion_resultado.error],
        /*String*/        [ tipo_operacion_resultado.error, tipo_operacion_resultado.error, tipo_operacion_resultado.error, tipo_operacion_resultado.menorque_cadena_numerico, tipo_operacion_resultado.mayorque_cadena,          tipo_operacion_resultado.error, tipo_operacion_resultado.error],
    ...
    public ejecutar(entorno_padre : Map<String,Simbolo>, salida : Middle)
    {
        ...
        try
        {
            ...
            switch(tipo_menor_que)
            {
                ...
                default:
                    ...
                    _return.setFila(this.fila);
                    _return.setColumna(this.columna);
                    _return.setValor("No es posible realizar una Comparación Menor Que del tipo: " + op1.getTipo().getTraduccion()  +  " * " + op2.getTipo().getTraduccion());
                    return _return;
            }
        }
        catch(Exception)
        {
            ...
            _return.setFila(this.fila);
            _return.setColumna(this.columna);
            _return.setValor("Operacion Menor Que: " + Exception.Message);
            return _return;
        }
    }
