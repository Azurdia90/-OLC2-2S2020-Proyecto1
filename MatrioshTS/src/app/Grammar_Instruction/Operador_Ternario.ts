...
class Operador_Ternario extends Expresion
{
    ...
    public ejecutar(entorno_padre : Map<String,Simbolo>, salida : Middle)
    {
        ...
        try
        {
            tmp_val = (this.condicion == null) ? null : this.condicion.ejecutar(entorno_padre, salida);
            ...
            if (tmp_val == null)
            {
                ...
                _return.setValor("Expresión de condición vacio.");
                return _return;
            }
            ...
            if (tmp_val.getTipo().getTipo() != tipo_dato.BOOLEANO)
            {
                ...
                _return.setFila(this.fila);
                _return.setColumna(this.columna);
                _return.setValor("No es posible realizar Operador Ternario si la condicón no devuelve un valor Booleano.");
                return _return;
            }
            else
            {   
        ...
        catch(Exception)
        {
            ...
            _return.setFila(this.fila);
            _return.setColumna(this.columna);
            _return.setValor("Operador Ternario: " + Exception.Message);
            return _return;
        }
    }
