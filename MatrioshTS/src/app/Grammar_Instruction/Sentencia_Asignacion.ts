        ...
        {   //console.log(this.tipo);
            ...
            else if(this.tipo == 1)
            {
                ...
                if(simbolo_tmp.getRol() == tipo_rol.arreglo)
                {
                    ...
                    {
                        var val_tmp: Simbolo;
                        val_tmp = this.acceso1[x].ejecutar(entorno_padre,salida);
                        ...
                        else
                        {
                            ...
                            _return.setValor("Sentencia Asignación: El valor de acceso debe ser tipo númerico.");
                            return _return;
                        }
                    }
                    ...
                    if(arreglo_tmp.length > 0 && lista_tamaños.length > 0)
                    {
                        ...
                        if(lista_tamaños.length == lista_accesos.length)
                        {
                            ...
                            if(pos_rel < 0)
                            {
                                ...
                                _return.setFila(this.fila);
                                _return.setColumna(this.columna);
                                _return.setValor("Sentencia Asignación: Los valores de acceso no deben ser valores negativos.");
                                return _return;
                            }
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    _return.setFila(this.fila);
                                    _return.setColumna(this.columna);
                                    _return.setValor("Sentencia Asignación: El valor de las posiciones de acceso es mayor al tamaño del arreglo.");
                                    return _return;
                                }
                            }
                        }
                        else
                        {
                            ...
                            _return.setFila(this.fila);
                            _return.setColumna(this.columna);
                            _return.setValor("Sentencia Asignación: El cantidad de accesos no coincide con las dimensiones del arreglo.");
                            return _return;
                        }
                    }
                    else
                    {   
                        ...
                        _return.setFila(this.fila);
                        _return.setColumna(this.columna);
                        _return.setValor("Sentencia Asignación: El arreglo no a sido instanciado.");
                        return _return;
                    }
                }
                ...
                else
                {
                    ...
                    _return.setFila(this.fila);
                    _return.setColumna(this.columna);
                    _return.setValor("Sentencia Asignación: Se especificaron dimension(es) de acceso para un No arreglo.");
                    return _return;
                } 
            }
            else if(this.tipo == 2)
            {
                _acceso = this.acceso2.ejecutar(entorno_padre, salida);
            }
            else
            {
                _return = new Simbolo(tipo_rol.error,new Tipo(tipo_dato.CADENA),"33-12"); 
                _return.setValor("Sentencia Asignación: El tipo de asignación no definido.");
                _return.setFila(this.fila);
                _return.setColumna(this.columna);
                return _return;
            }
            ...
            {
                _return = new Simbolo(tipo_rol.error,new Tipo(tipo_dato.CADENA),"33-12"); 
                _return.setValor("Sentencia Asignación: El tipo de la variable es diferente al valor a asignar.");
                _return.setFila(this.fila);
                _return.setColumna(this.columna);
                return _return;
            } 
            ...
            {
                _return = new Simbolo(tipo_rol.error,new Tipo(tipo_dato.CADENA),"33-12"); 
                _return.setValor("Sentencia Asignación: No es posible Asignar un valor a una constante.");
                _return.setFila(this.fila);
                _return.setColumna(this.columna);
                return _return;
            }
