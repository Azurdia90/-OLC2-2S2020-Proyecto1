...
class Mayor_Igual_Que extends Expresion
{
    ...
    [   /*                                      void                            nulo                           booleano                         numero                                           cadena                                                 identificador                          error 
        ...
        /*numero*/        [ tipo_operacion_resultado.error, tipo_operacion_resultado.error, tipo_operacion_resultado.error, tipo_operacion_resultado.mayorigualque_numerico,        tipo_operacion_resultado.mayorigualque_cadena_numerico, tipo_operacion_resultado.error, tipo_operacion_resultado.error],
