...
class Mayor_Que extends Expresion
{
    ...
    [   /*                                      void                            nulo                           booleano                         numero                                           cadena                                       identificador                          error 
        ...
        /*numero*/        [ tipo_operacion_resultado.error, tipo_operacion_resultado.error, tipo_operacion_resultado.error, tipo_operacion_resultado.mayorque_numerico,        tipo_operacion_resultado.mayorque_cadena_numerico, tipo_operacion_resultado.error, tipo_operacion_resultado.error],
